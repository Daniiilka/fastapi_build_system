...
def test_get_mock_tasks():
    ...
    assert response.text == "[\"test2\",\"test3\",\"test1\",\"test6\",\"test5\",\"test4\"]"
...
def test_get_real_tasks():
    ...
    assert response.text == '["build_teal_leprechauns","enable_yellow_centaurs","bring_olive_centaurs",' \
                            ...
                            '"bring_blue_centaurs","read_yellow_centaurs","create_olive_centaurs",' \
                            '"coloring_aqua_centaurs","coloring_aqua_golems","coloring_navy_golems",' \
                            '"map_black_leprechauns","upgrade_white_leprechauns","map_olive_leprechauns",' \
                            '"enable_lime_leprechauns","create_aqua_humans","enable_olive_humans",' \
                            '"build_maroon_humans","write_silver_humans","write_white_humans","create_purple_humans",' \
                            '"train_white_humans","write_teal_humans","enable_silver_humans","bring_blue_ogres",' \
                            '"design_white_ogres","train_green_ogres","upgrade_aqua_ogres","write_silver_ogres",' \
                            '"enable_fuchsia_ogres","bring_green_ogres","build_yellow_ogres","create_maroon_ogres",' \
                            '"design_green_ogres","upgrade_navy_ogres","write_blue_ogres","write_fuchsia_golems"]'
